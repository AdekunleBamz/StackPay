/*
 * lib/
 * Updated for Stacks.j
 * Use
 
import { STACKS_MAINNET, STACKS_TESTNET } from "@stacks/network";
// Read network type from environ
const networkEnv = process.env.NEXT_PUBLIC_NETWORK || "testnet"

/*
 * In v6+, StacksMainnet and StacksTestne clsse were removed.
 * We now use the static STACKS_MAINNET and STACKS_TESTNET objects
 * If you need a custom URL, you siply sprea the object and over
 *
